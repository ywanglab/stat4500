...
\begin{tcolorbox}[enhanced jigsaw, breakable, titlerule=0mm, opacityback=0, left=2mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, coltitle=black, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm]

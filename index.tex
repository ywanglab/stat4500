...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, rightrule=.15mm, leftrule=.75mm, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toptitle=1mm, left=2mm, opacityback=0, bottomtitle=1mm, arc=.35mm, colback=white, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]

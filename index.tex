...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, arc=.35mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, coltitle=black, rightrule=.15mm, bottomtitle=1mm, titlerule=0mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, breakable, left=2mm, leftrule=.75mm, opacitybacktitle=0.6]

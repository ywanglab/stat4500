 ...
 **some ideas**: 
  ...
  * create a single model for all stockes. Needs to embed each stock in a feature space. Research? 

**Startup code**: refer to the page <https://github.com/ywanglab/Predicting_stock_movement/blob/main/Time_series_stock_data_analysis_ver2.ipynb>. 

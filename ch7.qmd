...
$$
where, $\ell_0^T =(1, x_0, x_0^2, \cdots, x_0^d)$, and $\hat{\bf{C}}$ is the covariance matrix of the estimated coefficients $\beta_j$, $j=0, 1, \cdots, d$ obtained from the OLS. 
...
**Pros and Cons of GAM**
  ...
  * low dimensional interaction functions of the form $f_jk}(X_j, X_k)$ can be added. Such term can be fit using a two-dimensional smoothers such as local regression or two dimensional splines. 
